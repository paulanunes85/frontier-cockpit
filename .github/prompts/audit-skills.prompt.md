...
3. **Portability.** No sandbox home paths, mounted skill paths, or mounted user-data paths anywhere in the skill. No hard platform-product dependency in active copy. Model names and citations are allowed.
...
# sandbox path leaks
grep -rnI "/home/[^ ]*\|/mnt/skills\|/mnt/user-data" .github/skills && echo "LEAKS FOUND" || echo "clean"
```
