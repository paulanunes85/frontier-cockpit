...
- **Exported SVG** for embedding in Markdown and the ms-identity documents and decks.
...
- Apply the ms-identity palette to containers, labels, and connectors, never to the vendor icons themselves.
