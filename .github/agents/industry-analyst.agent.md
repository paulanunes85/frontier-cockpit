...
2. Apply the `ms-identity` design system and Microsoft identity to any rendered output (Frontier Cockpit Team, Software Global Black Belt; no personal social handles).
